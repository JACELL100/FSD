  ...
  return (
    <section className="relative z-10 py-20 bg-[#231A1D]">
      <div className="container mx-auto px-6 text-center">
        {/* 🔹 Section Title */}
        <h2 className="text-5xl font-bold text-rose-500 font-lilita mb-12">Testimonials</h2>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="flex justify-center mb-4">
                <img src={testimonial.image} alt={testimonial.name} className="w-16 h-16 rounded-full border-2 border-[#FF6B6B]" />
              </div>
              <p className="text-gray-300 italic mb-4">"{testimonial.feedback}"</p>
              <h3 className="text-lg font-semibold text-[#FFEBE5]">{testimonial.name}</h3>
