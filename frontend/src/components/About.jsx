    ...
    >
      ...
      <div className="relative w-full max-w-5xl mt-20">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-gray-800/20 to-gray-900/20 rounded-2xl shadow-[0_15px_40px_-15px_rgba(0,0,0,0.5)] 
          ...
          {/* Hover Overlay */}
          <div className="absolute inset-0 z-20 bg-black/0 group-hover:bg-black/40 
            rounded-2xl 
